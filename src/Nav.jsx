...
function Nav() {
  ...
  return (
    <div className="mx-auto mt-3 flex h-[55px] w-[550px] items-center bg-gradient-to-r from-fuchsia-900 to-purple-600 drop-shadow-md md:w-[550px]">
      <span className="ml-3">
        <svg
      ...
      <div className="space-x-44 sm:w-full">
        <span className="ml-1 text-white">Meme Generator</span>
      </div>
    </div>
  );
}
